...
const BillsPage: React.FC = () => {
    ...
    useEffect(() => {
        axios
            ...
            .catch(() => setError('Erro ao carregar informações das cédulas.'));
    }, []);
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-4">💵 Inventário de Cédulas</h2>
            ...
            {bills ? (
                <div className="space-y-4">
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                        Total de cédulas recebidas: <strong>{bills.totalBillsReceived}</strong>
                    </p>

                    <table className="w-full border border-gray-200 dark:border-gray-700 text-sm">
                        <thead className="bg-gray-100 dark:bg-gray-800">
                        <tr>
                            <th className="p-2 border-b dark:border-gray-600 text-left text-gray-700 dark:text-white">Cédula ($)</th>
                            <th className="p-2 border-b dark:border-gray-600 text-left text-gray-700 dark:text-white">Quantidade</th>
                        </tr>
                        </thead>
                        <tbody>
